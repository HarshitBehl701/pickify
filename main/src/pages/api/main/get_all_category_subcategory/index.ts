...
import { ICategory, ICategoryWithSubCategoryQueries, ICategoryWithSubCategoryResponse } from "@/interfaces/modelInterface";
...
async function handler(req: NextApiRequest, res: NextApiResponse) {
    try {
        ...
        return res.status(200).json(responseStructure(true, "Successfully fetched all categories and subcategories", categoriesAndSubCategories));
